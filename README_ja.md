...
- **📥 柔軟なダウンロードオプション**：
  - **-single ダウンロード**：ダウンロードボタンでロゴ付きバージョンを取得（R_/S_ プレフィックス）。「N」チェックでロゴなしバージョンをダウンロード可能。
  - **一括ダウンロード**：ロゴをアップロードすると、ZIPには両方のバージョンが含まれます：
    - ロゴ付き：`R_画像_clean.png`（横向き）/ `S_画像_clean.png`（縦向き）
    - ロゴなし：`N_画像_clean.png`
